...
const Header = () => {
	return (
		<div className="relative overflow-hidden pt-[120px] lg:pt-[160px] pb-[56px] lg:pb-[100px] header-area bg-[url('../assets/images/header/header_bg_small.png')] lg:bg-[url('../assets/images/header/header_bg.png')] bg-cover lg:bg-100% bg-no-repeat">
